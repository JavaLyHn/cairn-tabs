...
export const ja: Messages = {
  ...
  'context.newTab': '新しいタブ',
  'context.newTabTitle': 'このタスク内に新しいタブを開く',
  'context.more': 'その他',
  ...
  'tabRow.duplicate': '重複',
  'tabRow.unclear': 'AI が分類に迷い、そのままにしました:{reason}',
  'tabRow.unclearGeneric': 'AI が分類に迷い、そのままにしました',
  ...
  'aiPlan.unclear': '判断できず · そのまま',
  'aiPlan.summary.moved': '移動 {n}',
  'aiPlan.summary.newGroups': '新規 {n} グループ',
  'aiPlan.summary.unchanged': '変更なし {n}',
  'aiPlan.summary.unclear': '判断できず {n}',
  'aiPlan.unchangedFold': '{n} 件はすでにここ(変更なし)',
  'aiPlan.applyN': '適用({n} 件の変更)',
  'aiPlan.noChanges': '変更は不要です',
  ...
  // ── starred ─────────────────────────────────────────────────────────────────
  'starred.title': 'スター付き',
  'starred.remove': 'スター付きから外す(タブは閉じない)',
  ...
  // ── undo ────────────────────────────────────────────────────────────────────
  'undo.label': 'アーカイブ済み',
  'undo.archivedInto': '「{name}」に格納しました',
  'undo.action': '元に戻す',
