...
export const ko: Messages = {
  ...
  'context.newTab': '새 탭',
  'context.newTabTitle': '이 작업에 새 탭 열기',
  'context.more': '더 보기',
  ...
  'tabRow.duplicate': '중복',
  'tabRow.unclear': 'AI가 분류를 확신하지 못해 그대로 두었습니다: {reason}',
  'tabRow.unclearGeneric': 'AI가 분류를 확신하지 못해 그대로 두었습니다',
  ...
  'aiPlan.unclear': '불확실 · 원위치 유지',
  'aiPlan.summary.moved': '이동 {n}',
  'aiPlan.summary.newGroups': '새 그룹 {n}',
  'aiPlan.summary.unchanged': '변경 없음 {n}',
  'aiPlan.summary.unclear': '불확실 {n}',
  'aiPlan.unchangedFold': '{n}개 이미 여기(변경 없음)',
  'aiPlan.applyN': '적용({n}개 변경)',
  'aiPlan.noChanges': '변경할 내용이 없습니다',
  ...
  // ── starred ─────────────────────────────────────────────────────────────────
  'starred.title': '즐겨찾기',
  'starred.remove': '즐겨찾기에서 제거(탭은 닫지 않음)',
