...
export const en = {
  ...
  'context.newTab': 'New tab',
  'context.newTabTitle': 'New tab in this task',
  'context.more': 'More',
  ...
  'aiPlan.summary.moved': 'Moved {n}',
  'aiPlan.summary.newGroups': 'New groups {n}',
  'aiPlan.summary.unchanged': 'Unchanged {n}',
  'aiPlan.summary.unclear': 'Unsure {n}',
  'aiPlan.unchangedFold': '{n} already here (unchanged)',
  'aiPlan.applyN': 'Apply ({n} changes)',
  'aiPlan.noChanges': 'No changes needed',
