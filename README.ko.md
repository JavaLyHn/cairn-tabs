...
- **내보내기** (F-12) — 작업을 Markdown으로 원클릭 내보내기 (제목 + 링크, 클립보드에 복사, 스탠드업 / Notion용); 설정의 "전체 데이터 내보내기 (JSON)"로 백업 / 마이그레이션.
...
**데이터 및 백업:** 모든 작업/탭은 브라우저의 로컬 IndexedDB에 저장되며 업로드되지 않습니다. 설정의 "전체 데이터 내보내기 (JSON)"를 사용하여 언제든지 백업 / 마이그레이션하세요.
